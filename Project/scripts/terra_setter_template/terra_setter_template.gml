...
function terra_setter_template(grid, xx, yy, replace, value)
{
	//Example: This would be the default behavior when no function is provided.
	terra_set(grid, xx, yy, replace, value); //Replace with your own code.
}
...
function terra_setter_sin(grid, xx, yy, replace, value)
{
